...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_whatsapp_users_code'), 'whatsapp_users', ['code'], unique=True)
    ...
    op.create_index(op.f('ix_whatsapp_threads_code'), 'whatsapp_threads', ['code'], unique=True)
    ...
    sa.ForeignKeyConstraint(['thread_id'], ['whatsapp_threads.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['whatsapp_users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_whatsapp_messages_code'), 'whatsapp_messages', ['code'], unique=True)
