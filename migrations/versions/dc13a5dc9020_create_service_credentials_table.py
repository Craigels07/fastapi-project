...
Revision ID: dc13a5dc9020
Revises: 0c770b54f8b9
Create Date: 2025-05-31 20:50:23.763879
...
revision: str = 'dc13a5dc9020'
down_revision: Union[str, None] = '0c770b54f8b9'
...
def upgrade() -> None:
    ...
    sa.Column('service_type', sa.Enum('WOOCOMMERCE', 'TAKEALOT', 'OCTIVE', name='servicetypeenum'), nullable=False),
    ...
    op.create_index(op.f('ix_service_credentials_id'), 'service_credentials', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_service_credentials_id'), table_name='service_credentials')
