...
class ServiceRegistry:
    ...
    def register(cls, service_class: Type[ServiceInterface]):
        ...
        if not service_type:
            raise ValueError(f"Service class {service_class.__name__} must define a _service_type class attribute")
    ...
    @classmethod
    def create_service_instance(cls, service_type: str, **kwargs) -> Optional[ServiceInterface]:
    ...
    @classmethod
    def find_capable_service(cls, organization_services: List[Dict[str, Any]], 
                           message_purpose: str, message_details: Dict[str, Any], 
                           **kwargs) -> Optional[ServiceInterface]:
        """
